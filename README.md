...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-phylotate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9785&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-phylotate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-phylotate` can be installed with:

```
conda install r-phylotate
```

It is possible to list all of the versions of `r-phylotate` available on your platform with:
